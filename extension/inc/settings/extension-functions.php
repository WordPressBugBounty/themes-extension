...
function extension_scripts() {
	...
	wp_enqueue_style('extension-font-icons', get_template_directory_uri().'/assets/font-icons/css/all.min.css');
...
function extension_inline_fonts() {
	...
	wp_register_style( 'extension-google-fonts', wptt_get_webfont_url('https://fonts.googleapis.com/css?family='.$extension_googlefonts .':300,400,600,700'));
